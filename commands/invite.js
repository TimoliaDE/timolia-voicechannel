  ...
  async execute(interaction, client) {
    ...
    if (member.voice.channel) {
      ...
      if (user.bot === true || user.system === true) {
        return interaction.reply(
            {ephemeral: true, embeds: [notAUser]});
      }
    ...
    user.send({ephemeral: true, embeds: [welcome]}).catch(() => console.log(
        user.username + " hat Direktnachrichten deaktiviert!"))
  },
};